...
export default function AboutKoi() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen w-full bg-cover bg-center overflow-visible py-20 bg-gray-900"
      // style={{
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "url('/pattern.png')", // Replace with your second image path
          backgroundSize: "cover",
          backgroundPosition: "center",
      ...
      <div className="container relative overflow-visible">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          {/* Content container with relative positioning */}
          <div className="relative w-full lg:w-1/3 min-h-[500px]"></div>
          <div
            ref={textRef}
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none">
        <svg ref={koiRef} viewBox="0 0 540 540" className="w-full h-full">
          <defs>
            ...
            {/* <circle id="pond-boundary" cx="0" cy="270" r="2000"></circle> */}
        ...
        >
          <g
            id="koi2"
            fill="none"
            transform="translate(-150 -200) rotate(-45 60 70)"
          >
            <defs>
              <linearGradient
                x1="100%"
              ...
              <circle id="pond-boundary" cx="270" cy="270" r="2000"></circle>
              ...
              <g id="pond-contents">
                ...
                <g mask="url(#pond-mask)">
                  ...
                  >
                    ...
                    <g id="body">
                      <mask id="mask-koi-body" fill="black">
                        <use href="#koi-body-path"></use>
                      </mask>
                      <use fill="#FFFFFF" href="#koi-body-path"></use>
                      <g>
