...
const events = [
  ...
  {
    title: "Japanese Calligraphy Class",
    time: "6:30 PM",
    location: "Art Studio",
  },
...
<<<<<<< Updated upstream
    <section ref={sectionRef} className="py-20 bg-gray-900 text-white w-full h-full bg-red-900 bg-[url('/eventsbg.jpg')] relative">
      <img src="/sushi.svg" alt="Background pattern" width={1000} height={1000} className="absolute right-[0%] bottom-[0%] w-[90%] h-[90%]" />
...
=======
    <section
      ref={sectionRef}
      className="py-20 bg-gray-900 text-white w-full h-full bg-red-900 bg-[url('/eventsbg.jpg')] relative"
    >
      <Image
        src="/sushi.svg"
        ...
        width={1000}
        height={1000}
        className="absolute right-[0%] bottom-[0%] w-[90%] h-[90%]"
      />
      <div className="container mx-auto px-4 absolute left-[4%] top-[10%] w-[50%] h-[90%]">
        <h2
        ...
        <span>
          <p className="text-xl text-gray-300 leading-relaxed">
            Infin8 is a three-day extravaganza filled with vibrant shows,
            performances, competitions, games, and stalls.
>>>>>>> Stashed changes
          </p>
        </span>
      </div>
