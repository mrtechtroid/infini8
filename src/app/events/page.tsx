  ...
  return (
    ...
    <>
        ...
        <div className="flex flex-col rounded-lg overflow-hidden shadow-lg">
          ...
          <div className="bg-white rounded-b-lg">
            <div className="px-4 py-3 text-center">
              <h3 className="text-base font-medium text-gray-900 truncate font-['The Last Shuriken']">
                {name}
              </h3>
      ...
      <EventModal 
        ...
        event={{ id: event_id, name, prizePool, image }}
      />
    </>
  );
}
...
export default function EventsPage() {
  ...
  return (
    <div className="min-h-screen bg-red-600 bg-[url('/japanese-texture.png')] bg-repeat relative">
      {/* Navigation */}
